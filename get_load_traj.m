...
load_traj.l = 1 + 0.5*sin(2*pi*f4*t);
load_traj.dl = 0.5*2*pi*f4*cos(2*pi*f4*t);
load_traj.d2l = -0.5*((2*pi*f4)^2)*sin(2*pi*f4*t);
load_traj.d3l = -0.5*((2*pi*f4)^3)*cos(2*pi*f4*t);
load_traj.d4l =  0.5*((2*pi*f4)^4)*sin(2*pi*f4*t);
